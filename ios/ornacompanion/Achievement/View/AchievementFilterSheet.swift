...
struct AchievementFilterSheet: View {
...
struct AchievementFilterSheet_Previews: PreviewProvider {
    static var previews: some View {
        AchievementFilterSheet(vm: AchievementViewModel(), showFilter: .constant(true))
    }
}
