...
import nl.bryanderidder.ornaguide.databinding.ItemMonsterQuestBinding
import nl.bryanderidder.ornaguide.monster.model.Monster
import nl.bryanderidder.ornaguide.shared.util.SharedPrefsUtil

class MonsterQuestsAdapter(
    private val sharedPrefsUtil: SharedPrefsUtil
) : RecyclerView.Adapter<MonsterQuestsAdapter.MonsterViewHolder>() {

    private val items: MutableList<Monster.IdNamePair> = mutableListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MonsterViewHolder {
        val binding =
            parent.binding<ItemMonsterQuestBinding>(R.layout.item_monster_quest)
...
//                }
    ...
    class MonsterViewHolder(val binding: ItemMonsterQuestBinding) :
